...
MonoBehaviour:
  ...
  m_OverlayCanvas:
    ...
    - dockPosition: 0
      ...
      index: 2
      contents: '{"m_Layout":4,"m_Collapsed":false,"m_Folded":false,"m_Floating":false,"m_FloatingSnapOffset":{"x":-254.0,"y":25.0},"m_SnapOffsetDelta":{"x":0.0,"y":0.0},"m_FloatingSnapCorner":1,"m_Size":{"x":0.0,"y":0.0},"m_SizeOverridden":false}'
      floating: 0
      collapsed: 0
      snapOffset: {x: -254, y: 25}
      snapOffsetDelta: {x: 0, y: 0}
      snapCorner: 1
      layout: 4
      size: {x: 0, y: 0}
  ...
  m_Position:
    m_Target: {x: 1.2340279, y: -1.8974166, z: -0.04708897}
    speed: 2
    m_Value: {x: 1.2659833, y: -1.8190352, z: -0.0375989}
  m_RenderMode: 0
  m_CameraMode:
    drawMode: 0
    name: Shaded
